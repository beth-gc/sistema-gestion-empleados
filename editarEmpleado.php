...
<body>
    ...
    <main class="presentacion">
            ...
            <div class="cuadro_informativo">
                ...
                Nombre:
                <input type="text" name="empleado_nombre" value="<?php echo htmlspecialchars($registro['nombre']); ?>">
                <br>
                Edad:
                <input type="number" name="empleado_edad" value="<?php echo htmlspecialchars($registro['edad']); ?>">
                 <br>
                <input type="hidden" name="empleado_id" value="<?php echo htmlspecialchars($registro['id']); ?>">
